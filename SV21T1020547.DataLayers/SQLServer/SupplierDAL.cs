...
namespace SV21T1020547.DataLayers.SQLServer
{
    public class SupplierDAL : BaseDAL, ICommonDAL<Supplier>
    {
        ...
        public bool InUsed(int id)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                var parameters = new { SupplierID = id };
                result = connection.ExecuteScalar<int>(sql: sql, param: parameters, commandType: CommandType.Text) == 1;
            }
    ...
    internal record NewRecord(string SupplierName, string ContactName, string Province, string Address, string Phone, string Email);
}
